...
/*
This goes in the footer of your index.html to add the serviceworker, dont forget the manifest too!
  <script>
    if(navigator.serviceWorker.controller){console.log('active service worker found, no need to register')}
    else{navigator.serviceWorker.register('serviceworker',{scope:'./'}).then(function(reg){
